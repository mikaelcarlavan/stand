...
class Stand extends CommonObject
{
     ...
     *  @return    StandLine              <0 if KO, >0 if OK
     */
    ...
    public function LibStatut($status, $mode)
    {
        ...
        if ($status) {
            $labelStatus = $langs->transnoentitiesnoconv('StandActive');
            $labelStatusShort = $langs->transnoentitiesnoconv('StandActive');
            $statusType = 'status4';
        } else {
            $labelStatus = $langs->transnoentitiesnoconv('StandInactive');
            $labelStatusShort = $langs->transnoentitiesnoconv('StandInactive');
            $statusType = 'status8';
        }
